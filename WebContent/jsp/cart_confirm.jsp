...
<head>
    ...
    <style>
        ...
        .delete-btn { background: none; border: none; color: #ff4d4d; cursor: pointer; font-size: 18px; padding: 8px; }
        ...
        .payment-button { border: none; padding: 18px; text-align: center; font-size: 18px; font-weight: bold; border-radius: 12px; margin-top: 15px; cursor: pointer; width: 100%; display: flex; justify-content: center; align-items: center; gap: 10px; }
...
<div class="container">
    ...
    <% if (cartList != null && !cartList.isEmpty()) { %>
        ...
        %>
            <div class="item-box">
                <div class="item-info">
                    ...
                    <span class="price-text">¥<%= String.format("%,d", price) %> (×<%= qty %>)</span>
                </div>
        ...
        <form action="${pageContext.request.contextPath}/PaymentServlet" method="POST">
            ...
            <input type="hidden" name="itemName" value="カートの商品一式">

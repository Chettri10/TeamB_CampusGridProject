...
<%
    ...
    if (username == null || userId == null) {
        // ログイン画面へ飛ばす処理（必要に応じてコメントアウトを外してください）
        // response.sendRedirect("login.jsp"); // または "LogIn/login.jsp"
        // return;
    }
%>
<!DOCTYPE html>
...
<head>
<meta charset="UTF-8">
<title>CAMPUS GRID - Teacher Top</title>
...
<body>
    ...
    <div class="menu-row">
        <a class="menu-item green" href="<%= request.getContextPath() %>/AttManagementListServlet">
            <div class="icon">📋</div>
            出席状況一覧
        </a>
    ...
    <div class="menu-center">
        <a class="menu-item orange" href="qr_generator.jsp">
            <div class="icon">🏁</div>
            出席QR表示
        </a>
    </div>
